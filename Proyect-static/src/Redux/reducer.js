import { GET_BREEDS, GET_BREEDS_BYNAME, GET_TEMPERAMENTS, ORDER_BREEDS, FILTER_BREEDS, GET_DETAIL, CLEAR_DETAIL, CREATE } from './actions';
...
export default function rootReducer(state=initialState, action){
    switch(action.type){
        ...
        case CREATE: return({...state, breeds: action.payload, allbreeds: action.payload});
        ...
        case GET_DETAIL: 
            let idBreed = action.payload;
            let dogsFound = state.allbreeds.find(d => d.id.toString() === idBreed);
            return({...state, detail: dogsFound});
